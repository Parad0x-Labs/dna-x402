...
export DEPLOYER_KEYPAIR="${DEPLOYER_KEYPAIR:-$X402_DIR/test-mainnet/keys/devnet/deployer.json}"
export UPGRADE_AUTHORITY="${UPGRADE_AUTHORITY:-$X402_DIR/test-mainnet/keys/devnet/upgrade-authority.json}"
