#!/usr/bin/env node
/**
 * circuits/out/x402_access_v2_vk.json -> crates/dark-groth16-core/src/x402_access_v2_vk.rs
...
const VK_PATH = join(REPO, "circuits", "out", "x402_access_v2_vk.json");
const OUT = join(REPO, "crates", "dark-groth16-core", "src", "x402_access_v2_vk.rs");
const LABELS = ["root", "threshold", "scope_hash", "epoch", "nullifier", "agent_commitment"];
...
const rust = `//! x402 Access v2 Circuit Groth16 verifying key for dark_x402_access_gate.
//!
...
console.log(`Written: crates/dark-groth16-core/src/x402_access_v2_vk.rs`);
