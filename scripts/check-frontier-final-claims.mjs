#!/usr/bin/env node
/**
 * check-frontier-final-claims.mjs
...
const FORBIDDEN = [
  { phrase: "mainnet ready",         evidence: "dist/frontier-final/evidence/mainnet_deploy.json" },
  { phrase: "production ready",      evidence: "dist/frontier-final/evidence/mainnet_deploy.json" },
  { phrase: "audited",               evidence: "dist/frontier-final/evidence/audit_signed.json" },
  { phrase: "end-to-end private",    evidence: null }, // always forbidden
  { phrase: "end-to-end privacy",    evidence: null }, // always forbidden
  { phrase: "ZK verified",           evidence: "dist/frontier-final/evidence/zk_verifier_real.json" },
  { phrase: "Bonsol integrated",     evidence: "dist/frontier-final/evidence/bonsol_real.json" },
  { phrase: "RISC0 integrated",      evidence: "dist/frontier-final/evidence/risc0_real.json" },
  { phrase: "RISC Zero integrated",  evidence: "dist/frontier-final/evidence/risc0_real.json" },
  { phrase: "ZK Compression live",   evidence: "dist/frontier-final/evidence/zk_compression_real.json" },
  { phrase: "x402 production live",  evidence: "dist/frontier-final/evidence/x402_devnet_real.json" },
  { phrase: "Poseidon on-chain live", evidence: "dist/frontier-final/evidence/poseidon_real.json" },
];
...
const ALLOWLIST_FILES = [
  "docs/FRONTIER_FINAL_BASELINE.md",
  "docs/FRONTIER_FINAL_AUDIT_PACKET.md",
  "docs/FRONTIER_FINAL_RISK_REGISTER.md",
  "docs/MAINNET_FRONTIER_FINAL_GATE.md",
...
console.log("=== Dark Null Frontier Final Claim Checker ===\n");
