...
export const metadata: Metadata = {
  title: ".null — the web, without the rent",
  description:
    "Register a .null name on Solana mainnet and point it at a site on Arweave: $0/month, no server, no DNS, no host, nobody can take it down. Owned by your wallet, online forever. This is Web0.",
  icons: {
    icon:
